...
Both games are implemented from scratch in OOP style with the goal of being fully playable. The manager also supports persistent storage for creating and logging in users to keep track of high scores across sessions.
The following description includes: Overview, Design and Rules separate for each game, Installation Instructions, Usage, and Contributions.
...
## **Usage**
On top of the above design descriptions, the usage of the applciation is as follows:

1. **Run the Application**:
   - Install the applicaiton as instructed above.
...
3. **Main Menu**:
   - The main menu allows you to navigate through the different features of the game, including:
     - Creating or loggin into already existing account.
     - Starting a new Blackjack or Snake games.
     - Viewing high scores.
...
4. **Playing the Game**:
   - Once you start a new BlackJack game:
    ...
    - Once you start Snake game:
       - Snake will automatically display on the screen
       - You can move the snake by using keyboard arrow keys
...
## Contributions
- **Sunny Doan**: Implemented the Game Manager; worked on Login, High Scores, Main Menu, and Toolbar; ensured and fixed potential user input issues
- **Mohammed Nassar**: Implemented Snake Game, adding key features to make the game fully playable; worked on and assisted with fixing issues in the BlackJack game
- **Ania Niedzialek**: Implemented BlackJack Game, adding key features for the game layout; prepared README
